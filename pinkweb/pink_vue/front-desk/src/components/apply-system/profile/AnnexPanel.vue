      ...
      <el-row>
        <el-col :span="23">
          <div class="left-content">
            <ul class="left-up">
              <li>
                <el-upload class="upload-col" ref="upload" drag
                  action="http://localhost:8085/index/apply_edit/uploadResumePDF" :data="uploadData" accept=".pdf"
                  multiple :auto-upload="false" :limit="1" :on-success="handleFilUploadSuccess"
                  :on-remove="handleRemove">
                  <i class="el-icon-upload"></i>
                  <div class="el-upload__text">将文件拖到此处，或<em>点击上传</em></div>
                </el-upload>
                <span slot="footer" class="dialog-footer">
                  <el-button type="primary" @click="handleUpload" class="upload-btn" plain
                    style="font-size: 13px; padding: 8px 60px; margin-top: 20px" width="100%">
                    上传简历
                  </el-button>
                </span>
              </li>
        ...
        <!-- <el-col :span="12">
          ...
          <el-button size="small" type="primary" class="upload-btn" plain @click="turnResume"
            style="margin-left: 30px">在线快速制作</el-button>
        </el-col> -->
      </el-row>
    </el-dialog>
  </div>
