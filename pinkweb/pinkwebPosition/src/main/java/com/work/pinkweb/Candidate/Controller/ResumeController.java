...
public class ResumeController {
    ...
    public List<Resume> findAllResumePDF(@PathVariable Integer c_id) {
        return resumeService.findAllResumePDF(c_id);
    }
    ...
    public String resumeDownload(HttpServletResponse response, @RequestParam("r_id") Integer r_id) {
        return resumeService.resumeDownload(response, r_id);
    }
