...
public interface ManageService {
    ...
    PageInfo<Admin> getAdminByCondition(Integer pageIndex, Integer pageSize, String key
            , String flag);

    String manageAddUser(String admin_account, String admin_pwd, String admin_name,
                         Integer admin_power, String apartment, String position, Date admin_time);
